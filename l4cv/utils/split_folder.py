...
def split_folder(folder, tag="test_", test_proportion=0.1):
    ...
    test_folder = os.path.join(folder_lead, f"{tag}_{folder_name}")
...
if __name__ == "__main__":
    ...
    parser.add_argument("-t", "--tag", default="test_")

    args = parser.parse_args()

    folder = args.input_folder

    split_folder(folder, tag=args.tag)
